...
const insuranceGeneralController = require("../controller/Insurance/insuranceGeneralController");
...
router.get("/insurance/getLabs", auth, insuranceGeneralController.getLabs);
